...
class OTPMonitor:
    ...
    async def check_otp_loop(self, session_id: str):
        """Polling method - check OTP every 5 seconds from sender 777000"""
        ...
        logger.info(f"Started OTP polling for {session_info['phone_number']}")
...
app = FastAPI(
    ...
    description="Server for catching OTP codes from Telegram (Sender ID: 777000) using Polling Method",
    version="2.2.0",
    lifespan=lifespan
)
